#!/bin/sh
	...
	wget-ssl -4 -t 9 -T 3 -O /tmp/adbyby/adbyby_adblock/dnsmasq.adblock https://dev.tencent.com/u/Small_5/p/adbyby/git/raw/master/dnsmasq.adblock
	if [ "$?" != "0" ];then
	...
	wget-ssl -4 -t 9 -T 3 -O /tmp/adbyby/adbyby_adblock/md5 https://dev.tencent.com/u/Small_5/p/adbyby/git/raw/master/md5_1
	if [ "$?" != "0" ]; then
