...
download(){
	...
	wget-ssl -4 -t 9 -T 3 -O /tmp/lazy.txt https://dev.tencent.com/u/adbyby/p/xwhyc-rules/git/raw/master/lazy.txt
	if [ "$?" == "0" ]; then
		echo "Download Adbyby general rules from dev.tencent.com success!"
	else
		echo "Download Adbyby general rules from Github..."
		wget-ssl -4 -t 9 -T 10 -O /tmp/lazy.txt https://raw.githubusercontent.com/adbyby/xwhyc-rules/master/lazy.txt
		if [ "$?" == "0" ]; then
	...
	wget-ssl -4 -t 9 -T 3 -O /tmp/video.txt https://dev.tencent.com/u/adbyby/p/xwhyc-rules/git/raw/master/video.txt
	if [ "$?" == "0" ]; then
		echo "Download Adbyby video rules from dev.tencent.com success!"
	else
		echo "Download Adbyby video rules from Github..."
		wget-ssl -4 -t 9 -T 10 -O /tmp/video.txt https://raw.githubusercontent.com/adbyby/xwhyc-rules/master/video.txt
		if [ "$?" == "0" ]; then
...
checkfile(){
	...
	wget-ssl -4 -t 9 -T 3 -O /tmp/md5.json https://dev.tencent.com/u/adbyby/p/xwhyc-rules/git/raw/master/md5.json || wget-ssl -4 -t 9 -T 10 -O /tmp/md5.json https://raw.githubusercontent.com/adbyby/xwhyc-rules/master/md5.json
